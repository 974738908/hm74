  ...
  <el-container class="home-container">
    ...
    <el-container>
      <el-header class="my-header">
        <span class="el-icon-s-fold" @click="toggleMenu" collapse-transition:false></span>
        <span class="text">传智播客有限公司</span>
...
export default {
  ...
  methods: {
    ...
    // 2.此时你绑定了一个原始事件给组件 el-dropdown-item
    // 3.组件解析过后 这个标签是不存在的 事件绑定无效
    // 4.事件修饰符:@click.prevent 组织浏览器默认行为 @click.native 绑定原生的事件
    setting () {
